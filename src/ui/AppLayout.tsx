...
function TabLink({
  ...
  return (
    ...
    >
      <span className="text-lg sm:text-xl leading-none text-center">
        {icon}
      </span>
...
export default function AppLayout() {
  ...
  useEffect(() => {
    ...
    // If main.tsx captured the event earlier, use it
          ...
          >
            ...
            {state.auth.isLoggedIn ? (
              ...
              >
                ...
                <span className="hidden xs:inline">
                  {state.auth.user?.first_name || t("common.profile")}
                </span>
              </NavLink>
            ) : (
              <NavLink
        ...
        <div className="w-full">
          <div className="glass-card px-2 sm:px-3 py-2 m-2 sm:m-3">
            <div className="grid grid-cols-5 gap-1 sm:gap-2">
              ...
              <TabLink
                to="/reservations"
                label="navigation.myReservations"
                icon="📅"
              />
            </div>
          </div>
